...
\vspace{5em}
\begin{center}
\textbf{ОТЧЕТ ПО ЛАБОРАТОРНОЙ РАБОТЕ №1\\ Бинарное дерево}
\end{center}
...
\hbox to \textwidth
{\parbox{6 cm}{Студент\\ группы\\ ВТ-С-Б12}\dotfill \parbox{4 cm}{
\begin{flushright}Луценко~Г.А.\end{flushright}}}
\vspace{2em}
